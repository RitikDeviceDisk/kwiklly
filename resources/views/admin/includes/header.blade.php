            ...
            <ul class="list-unstyled">
                ...
                <li class="has-submenu">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li><a href="#">Display Product</a></li>
                        <li><a href="#">Import Product</a></li>
                        <li><a href="#">Import Variant Product</a></li>
                        <li><a href="#">Weight Master</a></li>
                    </ul>
                </li>
                <li class="has-submenu">
                ...
                <li class="has-submenu">
                    <a href="#"><i class="ion-navicon-round"></i> <span class="nav-label">Coupon</span></a>
                </li>
                <li class="has-submenu">
